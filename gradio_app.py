...
def generate(image, mc_resolution, formats=["obj", "glb"]):
    # formats: list of strings like ["obj","glb"]
    try:
    ...
    for fmt in formats:
        try:
            ...
            # If exporting a specific format fails, append an empty string and continue
            rv.append("")
    return rv
...
with gr.Blocks(title="2D to 3D") as interface:
    gr.Markdown(
        """
    # 2D to 3D Demo
    [2D to 3D] is a state-of-the-art open-source model for **fast** feedforward 3D reconstruction from a single image, collaboratively developed by [Tripo AI](https://www.tripo3d.ai/) and [Stability AI](https://stability.ai/).
