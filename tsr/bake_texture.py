import numpy as np
import torch
# xatlas is optional at import time; only required when baking textures.
try:
    import xatlas
except Exception:
    xatlas = None
...
def rasterize_position_atlas(
    ...
    try:
        ...
        raise RuntimeError("moderngl is required for rasterization when baking textures but is not installed on this system.")
